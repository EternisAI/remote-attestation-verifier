...
pub fn verify_remote_nitro_attestation(url: &str) -> Result<(), reqwest::Error> {
...
mod tests {
    ...
    #[test]
    fn test_external_nitro_verification() -> Result<(), reqwest::Error> {
        verify_remote_nitro_attestation(
            "http://ec2-13-60-183-0.eu-north-1.compute.amazonaws.com:8080/attestation",
        )
    }
